...
def train(args):
    ...
    angular_velo, acc_1, acc_2, sound = get_dataset_split(args.folder, args.speed,
                                                          scaled=args.scaled, experiment_dir=args.experiment_dir, tensor=True)
    ...
    path = "{}/saved_models/{}-{}.tar".format(args.save_dir, args.ae_path, sub_col[args.sub_columns][2])
...
if __name__ == "__main__":
    ...
    path = "{}/saved_models/motor-{}-{}-{}-pairs{}{}-{}{}-hnn-{}.tar".format(args.save_dir,
                                                                             folder, args.speed, args.latent_dim,
                                                                             fixed, split, subcol, baseline, args.ae_path)
