...
class MLP(torch.nn.Module):
  ...
  def __init__(self, input_dim, hidden_dim, output_dim, nonlinearity='tanh', dropout_rate=0.1):
...
class MLPAutoencoder(torch.nn.Module):
  ...
  def __init__(self, input_dim, hidden_dim, latent_dim, nonlinearity='tanh', dropout_rate=0.1):
